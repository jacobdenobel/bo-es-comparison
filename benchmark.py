...
from base_optimizer import BaseOptimizer, set_seeds
from config import *
...
class BenchmarkRunner:
    ...
    def run_single_experiment(self, 
                            ...
                            dimension: int, 
                            budget: int,
                            logger: Optional[ioh.logger.Analyzer] = None) -> None:
        """
    ...
    def run_benchmark(self, 
        ...
        print(f"Testing {len(functions)} functions, {len(instances)} instances, "
